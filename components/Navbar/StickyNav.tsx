...
export default function StickyNav() {
	...
	return (
		<div
			id="nav"
			className={`w-full h-[100px] top-0 left-0 z-[3] transition ease-in duration-150 relative ${
				...
				<div className="w-full flex items-center max-lg:flex-col relative">
					...
					<div className="flex lg:flex-row flex-col text-[16px] justify-start max-lg:w-full flex-auto lg:space-x-4  text-white">
						<Link
							...
							className={` max-lg:pt-2  ${product1 ? "lg:text-white" : ""}  ${
								product || smallNav
						...
						<Link
							...
							className={` max-lg:pt-2 ${security1 ? "lg:text-white" : ""} ${
